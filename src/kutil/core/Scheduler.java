...
import myJade.KutilEnviromentAgent;
...
public class Scheduler {
    ...
    private KutilEnviromentAgent kutilEnviromentAgent = null;
    ...
    // přidáno v kutil-o-jadu !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    public Scheduler( KAtts l , KutilEnviromentAgent e ){
        loaded = l ;
        kutilEnviromentAgent = e;
        init2( loaded );
    }
    ...
    // přidáno v kutil-o-jadu !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    private void init2( KAtts kAtts ){
        calendar = new PriorityQueue<CalendarEvent>( 3, new CalendarEventComparator() );
        ...
        //start();    --- nenastartujem, místo toho se bude krokovat
    }
    ...
    public void informAboutEnvMsgHitTarget( String from , String targetID , String msgText ){
        if( kutilEnviromentAgent != null ){
            kutilEnviromentAgent.informAboutEnvMsgHitTarget( from, targetID, msgText);
        }
    }
    ...
    public long krok_(){
        ...
        //na dobu, než je naplánována další událost usneme
        // dříve sleep( calendar.peek().when - (ce.when + trvalo) );
        return calendar.peek().when - (ce.when + trvalo) ;
    }
