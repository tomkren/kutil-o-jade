...
public class Main {
    ...
    public static void main_( String[] args ){
        ...
        Scheduler scheduler = mkKutilScheduler() ;
        
        long timeToSleep = 0;
        
        while( timeToSleep != -1 ){
            
            timeToSleep = scheduler.krok_();
            //Log.it(timeToSleep);
            //Scheduler.sleep(timeToSleep);
        }
        
    }

    
    public static Scheduler mkKutilScheduler( ){
        ...
        if( loaded == null ) {
            ...
            return new Scheduler( loaded , null );
        }
    }
